...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e47]:
    - iframe [ref=e49]:
      - main [ref=f12e2]:
        - generic [ref=f12e3]: Processing your request. If this page doesn't refresh automatically, resubmit your request.
    - iframe [ref=e51]:
      - main [ref=f13e2]:
        - generic [ref=f13e5]: "21"
        - generic [ref=f13e6]:
          - paragraph [ref=f13e8]: Powered and protected by
          - img "Akamai" [ref=f13e10]
          - link "Privacy" [ref=f13e12] [cursor=pointer]:
            - /url: https://www.akamai.com/privacy
  - iframe [ref=e52]:
    - generic [ref=f14e3] [cursor=pointer]:
      - generic [ref=f14e5]:
        - img [ref=f14e8]
        - generic [ref=f14e11]: myntra.com wants to start sending you push notifications. Click Allow to subscribe.
      - generic [ref=f14e12]:
        - button "I'll do this later" [ref=f14e13]
        - button "Allow" [ref=f14e14]
```
